...
def draw_window_decorations(draw, explanation):
    ...
    draw.text(
        ((WIDTH - w_exp) // 2, HEIGHT - BOTTOM_BANNER_HEIGHT + 12),
        explanation,
        fill=BANNER_TEXT,
        font=banner_font,
    )
...
def main():
    ...
    doc_panel = [
        ...
        [
            ("┌─ ", BORDER_COLOR),
            ("MCP Debugger Environment Check", CYAN_COLOR),
            (" ─────────────────────────┐", BORDER_COLOR),
        ],
        [
            ("│ ", BORDER_COLOR),
            ("OK", GREEN_COLOR),
            (" Python version: 3.12.0 (required >=3.11)                   │", TEXT_COLOR),
        ],
        [
            ("│ ", BORDER_COLOR),
            ("OK", GREEN_COLOR),
            (" SQLite version: 3.42.0                                     │", TEXT_COLOR),
        ],
        [
            ("│ ", BORDER_COLOR),
            ("OK", GREEN_COLOR),
            (" Database directory: C:\\Users\\sushant\\.mcp-debugger [writable] │", TEXT_COLOR),
        ],
        [
            ("│ ", BORDER_COLOR),
            ("OK", GREEN_COLOR),
            (" Database file: .mcp-debugger\\sessions.db [exists]        │", TEXT_COLOR),
        ],
        [
            ("│ ", BORDER_COLOR),
            ("OK", GREEN_COLOR),
            (" Database schema version: 1                                 │", TEXT_COLOR),
        ],
        [
            ("│ ", BORDER_COLOR),
            ("OK", GREEN_COLOR),
            (" npx command found: C:\\Program Files\\nodejs\\npx             │", TEXT_COLOR),
        ],
        [
            ("│ ", BORDER_COLOR),
            ("OK", GREEN_COLOR),
    ...
    proxy_lines = doc_panel[-5:] + [
        ...
        [
            ("  ^C  Session saved. ID: ", TEXT_COLOR),
            ("#1", YELLOW_COLOR),
            ("  (8 messages)", TEXT_COLOR),
        ],
    ]
    ...
    inspect_lines = [
        ...
        [
            ("┌─ ", BORDER_COLOR),
            ("Session #1  my-session  (8 messages)", CYAN_COLOR),
            (" ─────────────┐", BORDER_COLOR),
        ],
        [
            ("│ ", BORDER_COLOR),
            ("#1 ", YELLOW_COLOR),
            ("client-->server  ", TEXT_COLOR),
            ("initialize", GREEN_COLOR),
            ("                          │", BORDER_COLOR),
        ],
        ...
        [
            ("│ ", BORDER_COLOR),
            ("#2 ", YELLOW_COLOR),
            ("server-->client  ", TEXT_COLOR),
            ("initialize result", GREEN_COLOR),
            ("                    │", BORDER_COLOR),
        ],
        ...
        [
            ...
            ("#5 ", YELLOW_COLOR),
            ("client-->server  ", TEXT_COLOR),
            ("tools/call  ", GREEN_COLOR),
            ("read_file", CYAN_COLOR),
            ("              │", BORDER_COLOR),
        ],
    ...
    cmd_5 = (
        'mcp-debugger validate --server "npx -y @modelcontextprotocol/server-filesystem C:\\temp"'
    )
    ...
    l_1 = val_lines_base + [
        "Validating live server: npx -y @modelcontextprotocol/server-filesystem C:\\temp"
    ]
    ...
    cmd_6 = (
        'mcp-debugger replay 1 --server "npx -y @modelcontextprotocol/server-filesystem C:\\temp"'
    )
    ...
    replay_lines = l_4[-6:] + [
        ...
        [
            ("┌─ ", BORDER_COLOR),
            ("Message Replay Summary", CYAN_COLOR),
            (" ─────────────────────────────┐", BORDER_COLOR),
        ],
        ...
        [
            ("│ ", TEXT_COLOR),
            ("OK", GREEN_COLOR),
            (" Successful matches: 8                                      │", TEXT_COLOR),
        ],
        [
            ("│ ", TEXT_COLOR),
            ("FAIL", RED_COLOR),
            (" Mismatches: 0                                              │", TEXT_COLOR),
        ],
        [("└─────────────────────────────────────────────────────────────┘", BORDER_COLOR)],
    ]
