...
def test_list_command_empty(mock_db_path: str, runner: CliRunner) -> None:
...
def test_list_command_populated(mock_db_path: str, runner: CliRunner) -> None:
...
def test_list_command_corrupted(mock_db_path: str, runner: CliRunner) -> None:
